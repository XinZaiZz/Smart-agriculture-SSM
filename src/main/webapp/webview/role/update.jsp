...
<body>
		...
		<div class="portlet box bordered">
			<div class="portlet-title">
				<div class="caption" style="color:#45A3CA;">
					<i class="fs icon-pin font-yellow-crusta"></i>修改角色信息
				</div>
			</div>
			<div class="portlet-body">
	
				<form name="修改角色信息表单" class="form-horizontal" action="${ctx}/role/save"  method="post">
					<div class="form-body">
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$("form[name=修改角色信息表单] button[title=保存]").on("click",function(){
				save("form[name=修改角色信息表单]");
			});

			$("form[name=修改角色信息表单] button[title=关闭]").on("click", function() {
