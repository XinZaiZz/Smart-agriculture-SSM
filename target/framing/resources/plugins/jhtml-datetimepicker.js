 ...
 * 
 * ----------------------------------------------------------------------------
 * 参考资料：http://www.malot.fr/bootstrap-datetimepicker
 */
!
function(t) {
    function e() {
    ...
    var i = function(e, i) {
        var a = this;
        this.element = t(e),
        this.language = i.language || this.element.data("date-language") || "cn",
        this.language = this.language in n ? this.language: "cn",
