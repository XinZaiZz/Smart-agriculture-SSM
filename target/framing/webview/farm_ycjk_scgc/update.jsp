...
<body>
		...
		<div class="portlet box bordered">
			<div class="portlet-title">
				<div class="caption"  style="color:#45A3CA;">
					<i class="fs icon-pin font-yellow-crusta"></i>修改生产过程
				</div>
			</div>
			<div class="portlet-body">
	
				<form name="修改生产过程表单" class="form-horizontal" action="${ctx}/farm_ycjk_scgc/save"  method="post">
					<div class="form-body">
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			loadRole("form[name=修改生产过程表单] select[name=yjdj]");

			if("${param.sid}"){
				$.ajax({
					type: "POST",
					dataType:"json",
					url: "${ctx}/farm_ycjk_scgc/getOne",
					data:{sid:"${param.sid}"},
					success: function(data) {
						//加载数据
						load("form[name=修改生产过程表单]",data);
