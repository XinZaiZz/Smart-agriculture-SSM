...
<html lang="zh">
<head>
<title>农业物联网生产系统-新增预警策略配置</title>
</head>
<body>
		...
		<div class="portlet box bordered">
			<div class="portlet-title">
				<div class="caption"  style="color:#45A3CA;">
					<i class="fs icon-pin font-yellow-crusta"></i>新增预警策略配置
				</div>
			</div>
			<div class="portlet-body">

                <form name="新增预警策略配置表单" class="form-horizontal" action="${ctx}/farm_ycjk_yjclpz/save"  method="post">
                    <div class="form-body">
    ...
    <script type="text/javascript" src="${ctx}/webview/farm_ycjk_yjclpz/script/farm_ycjk_addyjclpz.js" charset="UTF-8"></script>
